...
import com.bwie.zss.adapter.ChangePayApater;
import com.bwie.zss.aliplay.PayResult;
import com.bwie.zss.aliplay.SignUtils;
...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
    ...
    private PayData.DataBean paydata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paydata = (PayData.DataBean) getIntent().getExtras().get("paydata");
        Log.i("pay", paydata.getGoods_name());
        initId();
        initData();
        ChangePayApater changepayadapter=new ChangePayApater(PaySelectActivity.this,payitem_list);
    ...
    private void initId() {
        ...
        tv_paymoney.setText(paydata.getAmount()+"¥");
        tv_paypay = (TextView) findViewById(R.id.tv_paypay);
        tv_paypay.setText(paydata.getAmount()+"¥");
